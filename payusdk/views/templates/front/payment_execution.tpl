...
<div class="col-xs-12 col-sm-12 col-md-12">
					...
					<table style="width: 100%;">
						<tr>
							<td style="border: solid 1px; text-align: center;"  colspan="2">
								<b>{l s='Resumén de su pedido' mod='payusdk'}</b>
							<td>
						</tr>
						<tr>
    ...
    <h2>Selecciona:{$coCountry}</h2>
    <select name="pay-type" id="pay-type">
      <option value="">Medio de pago</option selected>
        ...
        <div class="container active">
         ...
         <div class="container" style="padding-top: 15px;">
          ...
          <div class="container">
          	...
          	<div class="col-xs-4">
          		<label for="dni" class="label">Cédula de Ciudadanía *</label>
...
<form action="{$ajax}" method="post" id="formCashPayu">
  <input type="hidden" value="{$accountId}" name="accountId">
          ...
          <div class="container">
            ...
            <div class="col-xs-12 alert alert-danger" id="msj-error"></div>
            <a href="#"><img src="{$this_path_bw}img/efecty.png" class="change-cash gray-scale" data-type="efecty" alt="efecty" style="margin-left:15px; margin-bottom:15px;"><img src="{$this_path_bw}img/baloto.png" class="change-cash gray-scale" data-type="baloto" alt="baloto" style="margin-left:15px; margin-bottom:15px;"></a>
              <label for="dni" class="label">Cédula de Ciudadanía *</label>
          <input type="text" class="form-control" id="dni" name="dni" placeholder="1056165896" required="">
            </div>
            </div>
...
<div id="payusdk-pse">
  <form action="{$ajax}" method="post" id="formPSEPayu">
          <input type="hidden" value="{$accountId}" name="accountId">
          <input type="hidden" value="{$merchantId}" name="merchantId">
          <input type="hidden" value="{$apiKey}" name="apiKey">
          <input type="hidden" value="{$apiLogin}" name="apiLogin">
          ...
          <input type="hidden" name="total">
          <input type="hidden" name="p_billing_email" value="{$p_billing_email}">
          <input type="hidden" id="telephone" name="telephone" required="" value="{$phone}">
          <div class="col-xs-12 alert alert-danger" id="msj-error"></div>
    <select name="pse" id="pse" required="">
      <option value="">Seleccione</option>
    </select>
    <div class="container" style="padding-top: 15px;">
          <div class="col-xs-6" >
          <label for="cc_name" class="label">Nombre del titular *</label>
            <input placeholder="Titular" type="text" name="cc_name" required="" class="form-control">
          </div>
          <div class="col-xs-4">
              <label for="typepserson" class="label">Tipo de cliente *</label>
          <select name="typepserson" class="form-control" id="typepserson" required="">
            ...
            <div class="col-xs-8">
            <label for="typeidn" class="label">Documento de identidad *</label>
            <select name="typeidn" class="form-control" id="typeidn" required="">
              <option value="">Tipo</option>
              <option value="CC">Cédula de Ciudania</option>
              <option value="CE">Cédula de Extranjeria</option>
              <option value="CEL">Número móvil</option>
              <option value="DE">Documento de identificación extranjero</option>
              <option value="IDC">Identificador único del cliente</option>
              <option value="NIT">Número de identificación tributaria</option>
              <option value="RC">Registro civil</option>
              <option value="TI">Tarjeta de identidad</option>
            </select>
            <input type="number" class="form-control" id="dni" name="dni" placeholder="1056165896" required="">
            </div>
    </div>
    <div class="container">
    <div class="col-xs-6"><input type="submit" class="form-payu" id="submit_payu" value="Pagar" style="background: #F0943E; color: #FFFFFF; font-size: 16px;" /></div>
...
<p style="background:url(https://maf.pagosonline.net/ws/fp?id={$sessionid}80200")></p>
  ...
  data="https://maf.pagosonline.net/ws/fp/fp.swf?id={$sessionid}80200" width="1" height="1" id="thm_fp">
    </div>
</div>
	{/if}
    </div>
